{ 
  ...
  //----------------------------------------------------------------------------------------------------//
    ...
    printf("X_shift   =%6.2f;  Y_shift   =%6.2f;  \/\/-FW_cuts_autoGenerated-- \n", X_shift, Y_shift );
    printf("X_shM[ 0] =%6.2f;  Y_shM[ 0] =%6.2f;  \/\/-FW_cuts_autoGenerated-- \n", X_shift, Y_shift );
    printf("X_shM[ 1] =%6.2f;  Y_shM[ 1] =%6.2f;  \/\/-FW_cuts_autoGenerated-- \n", hFWxyCCsmearM0 ->GetMean(1), hFWxyCCsmearM0 ->GetMean(2) );
    ...
    hRPAy0.Scale( 90./hRPAy0.GetEntries());  hRPAy0.SetMinimum(0.);
    ...
    hRPAc0c.Scale( 90./hRPAc0c.GetEntries() ); hRPAc0c.SetMinimum( 0.); hRPAc0c.SetLineColor(3);
    hRPAc1c.Scale( 90./hRPAc1c.GetEntries() ); hRPAc1c.SetMinimum( 0.); hRPAc1c.SetLineColor(3);
    hRPAc2c.Scale( 90./hRPAc2c.GetEntries() ); hRPAc2c.SetMinimum( 0.); hRPAc2c.SetLineColor(3);
    hRPAc3c.Scale( 90./hRPAc3c.GetEntries() ); hRPAc3c.SetMinimum( 0.); hRPAc3c.SetLineColor(3);
    hRPAc4c.Scale( 90./hRPAc4c.GetEntries() ); hRPAc4c.SetMinimum( 0.); hRPAc4c.SetLineColor(3);
    hRPAc5c.Scale( 90./hRPAc5c.GetEntries() ); hRPAc5c.SetMinimum( 0.); hRPAc5c.SetLineColor(3);
    hRPAc6c.Scale( 90./hRPAc6c.GetEntries() ); hRPAc6c.SetMinimum( 0.); hRPAc6c.SetLineColor(3);
    hRPAc7c.Scale( 90./hRPAc7c.GetEntries() ); hRPAc7c.SetMinimum( 0.); hRPAc7c.SetLineColor(3);
    hRPAc8c.Scale( 90./hRPAc8c.GetEntries() ); hRPAc8c.SetMinimum( 0.); hRPAc8c.SetLineColor(3);
    hRPAc9c.Scale( 90./hRPAc9c.GetEntries() ); hRPAc9c.SetMinimum( 0.); hRPAc9c.SetLineColor(3);
    hRPAc10c.Scale(90./hRPAc10c.GetEntries()); hRPAc10c.SetMinimum(0.); hRPAc10c.SetLineColor(3);
    ...
    c.cd( 1); hRPAy0 ->Draw(); hRPAy0 ->Fit("shape"); cos1[ 1] = shape->GetParameter(0); cos2[ 1] = shape->GetParameter(1); sin1[ 1] = shape->GetParameter(2); cos3[ 1] = shape->GetParameter(3); sin2[ 1] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 1], cos2[ 1], sin1[ 1], cos3[ 1], sin2[ 1]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 2); hRPAy1 ->Draw(); hRPAy1 ->Fit("shape"); cos1[ 2] = shape->GetParameter(0); cos2[ 2] = shape->GetParameter(1); sin1[ 2] = shape->GetParameter(2); cos3[ 2] = shape->GetParameter(3); sin2[ 2] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 2], cos2[ 2], sin1[ 2], cos3[ 2], sin2[ 2]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 3); hRPAy2 ->Draw(); hRPAy2 ->Fit("shape"); cos1[ 3] = shape->GetParameter(0); cos2[ 3] = shape->GetParameter(1); sin1[ 3] = shape->GetParameter(2); cos3[ 3] = shape->GetParameter(3); sin2[ 3] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 3], cos2[ 3], sin1[ 3], cos3[ 3], sin2[ 3]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 4); hRPAy3 ->Draw(); hRPAy3 ->Fit("shape"); cos1[ 4] = shape->GetParameter(0); cos2[ 4] = shape->GetParameter(1); sin1[ 4] = shape->GetParameter(2); cos3[ 4] = shape->GetParameter(3); sin2[ 4] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 4], cos2[ 4], sin1[ 4], cos3[ 4], sin2[ 4]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 5); hRPAy4 ->Draw(); hRPAy4 ->Fit("shape"); cos1[ 5] = shape->GetParameter(0); cos2[ 5] = shape->GetParameter(1); sin1[ 5] = shape->GetParameter(2); cos3[ 5] = shape->GetParameter(3); sin2[ 5] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 5], cos2[ 5], sin1[ 5], cos3[ 5], sin2[ 5]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 6); hRPAy5 ->Draw(); hRPAy5 ->Fit("shape"); cos1[ 6] = shape->GetParameter(0); cos2[ 6] = shape->GetParameter(1); sin1[ 6] = shape->GetParameter(2); cos3[ 6] = shape->GetParameter(3); sin2[ 6] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 6], cos2[ 6], sin1[ 6], cos3[ 6], sin2[ 6]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 7); hRPAy6 ->Draw(); hRPAy6 ->Fit("shape"); cos1[ 7] = shape->GetParameter(0); cos2[ 7] = shape->GetParameter(1); sin1[ 7] = shape->GetParameter(2); cos3[ 7] = shape->GetParameter(3); sin2[ 7] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 7], cos2[ 7], sin1[ 7], cos3[ 7], sin2[ 7]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 8); hRPAy7 ->Draw(); hRPAy7 ->Fit("shape"); cos1[ 8] = shape->GetParameter(0); cos2[ 8] = shape->GetParameter(1); sin1[ 8] = shape->GetParameter(2); cos3[ 8] = shape->GetParameter(3); sin2[ 8] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 8], cos2[ 8], sin1[ 8], cos3[ 8], sin2[ 8]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd( 9); hRPAy8 ->Draw(); hRPAy8 ->Fit("shape"); cos1[ 9] = shape->GetParameter(0); cos2[ 9] = shape->GetParameter(1); sin1[ 9] = shape->GetParameter(2); cos3[ 9] = shape->GetParameter(3); sin2[ 9] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[ 9], cos2[ 9], sin1[ 9], cos3[ 9], sin2[ 9]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd(10); hRPAy9 ->Draw(); hRPAy9 ->Fit("shape"); cos1[10] = shape->GetParameter(0); cos2[10] = shape->GetParameter(1); sin1[10] = shape->GetParameter(2); cos3[10] = shape->GetParameter(3); sin2[10] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[10], cos2[10], sin1[10], cos3[10], sin2[10]); txt.DrawTextNDC(0.10, 0.25, ds);
    c.cd(11); hRPAy10->Draw(); hRPAy10->Fit("shape"); cos1[11] = shape->GetParameter(0); cos2[11] = shape->GetParameter(1); sin1[11] = shape->GetParameter(2); cos3[11] = shape->GetParameter(3); sin2[11] = shape->GetParameter(4); sprintf(ds, "ini: c1=%4.3f c2=%4.3f s1=%4.3f c3=%4.3f s2=%4.3f", cos1[11], cos2[11], sin1[11], cos3[11], sin2[11]); txt.DrawTextNDC(0.10, 0.25, ds);
