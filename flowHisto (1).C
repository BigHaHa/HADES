...
for(Int_t i=0;i<11;i++){
    hFWxyCCsmearM[i]   = new TH2F(Form("hFWxyCCsmearM%i",i)  ,Form("hFWxyCCsmearXscanM %i",i),500,-1000.,1000.,500,-1000.,1000.);
}
...
for(Int_t i=0;i<11;i++){
    ...
    hsumXmean[i] = new TH2F(Form("hsumXmean%i",i),Form("hsumXmean %i",i),15,95.,110.,99, -50.,50.);
    hsumYmean[i] = new TH2F(Form("hsumYmean%i",i),Form("hsumYmean %i",i),15,95.,110.,99, -50.,50.);
    for (Int_t n=0;n<6;n++){
    ...
    hQvectX[  i] = new TH1F(Form("hQvectX%i",i),Form("hQvectX %i FW",i), 600, -50., 50.);
    hQvectY[  i] = new TH1F(Form("hQvectY%i",i),Form("hQvectY %i FW",i), 600, -50., 50.); 
    ...
    hQvRaw[   i] = new TH2F(Form("hQvRaw%i",i) ,Form("Qvect %i Raw",i), 600, -50., 50., 600, -50., 50.);
    hQvRec[   i] = new TH2F(Form("hQvRec%i",i) ,Form("Qvect %i Rec",i), 600, -5., 5., 600, -5., 5.);
}
